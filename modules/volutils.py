...
def march_and_save(occupancy, mesh_whl, mcubes_thres, savename, smoothen=False):
    '''
    ...
    vertices -= occupancy.shape[0]/2
    vertices /= occupancy.shape[0]/2
    vertices = vertices[:, [1, 0, 2]] # switch axes
    vertices *= mesh_whl
            
    mcubes.export_mesh(vertices.copy(), faces.copy(), savename)
