...
#     # Generate random x and y positions independently to avoid grid alignment
#     img_mask_x = torch.randint(0, H, (sampled_pc,))
#     img_mask_y = torch.randint(0, W, (sampled_pc,))
    
#     # Retrieve sampled pixel values
#     img_train = img_ground_truth[img_mask_x, img_mask_y]
    
#     # Normalize the mask coordinates to [0, 1]
#     img_mask_x = img_mask_x.float()
#     img_mask_y = img_mask_y.float()
